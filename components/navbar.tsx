...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 backdrop-blur-xl bg-white/70 dark:bg-gray-950/70 border-b border-gray-200/50 dark:border-gray-800/50">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="px-4 py-3 space-y-1 bg-white/90 dark:bg-gray-950/90 backdrop-blur-xl">
              {menuItems.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
